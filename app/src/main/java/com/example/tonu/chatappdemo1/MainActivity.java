...
import com.example.tonu.chatappdemo1.Fragments.ChatsFragment;
import com.example.tonu.chatappdemo1.Fragments.ProfileFragment;
import com.example.tonu.chatappdemo1.Fragments.UsersFragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                Log.e("IMAGE ",String.valueOf(user.getUsername()));
